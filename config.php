...
// define( "DB_DSN", "mysql:host=localhost;dbname=evidson_bell_schedule" );
// define( "DB_USERNAME", "evidson_bell_schedule" );
// define( "DB_PASSWORD", "Bell_schedule123" );
...
ini_set( "display_errors", false );  // for development version
